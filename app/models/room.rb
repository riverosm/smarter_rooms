class Room < ApplicationRecord
  ...
  def get_available_times (date = DateTime.now, from_time = "08:00")
    ...
    begin_time = DateTime.new(date.year, date.month, date.day, begin_hour, begin_minutes, 0)
    end_time = DateTime.new(date.year, date.month, date.day, end_hour, end_minutes, 0)
